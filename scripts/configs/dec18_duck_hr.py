...
def get_config():
        ...
        model=dict(
            ...
            heads=dict(
                ...
                mano=ModuleSpec.create(
                    ...
                    loss_weight=1.0,
                    constrain_loss_dims=True,
                    diffusion_steps=50, # new... was 5
                ),
            ),
            readouts=dict(single_arm=10, mano=10, bimanual=10),
        )
    )
    ...
    dataset_kwargs = get_dataset_config(
        "multi", window_size, action_horizon=action_horizon, mix="xduck"
    )
    config = dict(
        ...
        eval_datasets=("xgym_duck_single", "xgym_duck_mano"),
        rollout_kwargs=dict(
            num_envs=4,
            use_rollout=False,
        ),
