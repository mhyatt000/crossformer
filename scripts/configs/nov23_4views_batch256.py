...
def get_augmentation_config(task_cond, window_size, action_horizon):
    ...
    frame_transform_kwargs = dict(
        ...
        image_augment_kwargs={
            ...
            'front': bridge_image_augment_kwargs ,
...
def get_config():
    ...
    UPDATE_CONFIG = dict(
        model=dict(
            observation_tokenizers=dict(
                front=ModuleSpec.create( 
                    ImageTokenizer, 
                      obs_stack_keys=["image_front"], 
                      task_stack_keys=["image_front"], 
    ...
    dataset_kwargs = get_dataset_config(
        "multi", window_size, action_horizon=action_horizon, mix="x"
    )
    config = dict(
