...
class HttpServer:
    def __init__(self, paths):
        ...
        self.dataset_name = "xgym_lift_single"
        self.action_dim = 7
        self.pred_horizon = 4
        self.exp_weight = 0
        self.horizon = 1  # 5
...
def main():
    ...
    paths = [
        ...
        # ("bafl", osp.join(root, "experiment_20241016_154027"), 64_000),
        # ("bafl", osp.join(root, "experiment_20241018_033508"), 50_000),
        # ("bafl", osp.join(root, "experiment_20241017_160859"), 250_000),
        # ("bafl", osp.join(root, "experiment_20241021_213320"), 10_000),
        # ("bafl", osp.join(root, "experiment_20241025_200732"), 50_000),
        # ("bafl", osp.join(root, "experiment_20241028_105119"), 10_000),
        # ("bafl", osp.join(root, "experiment_20241029_172038"), 10_000),
        # lift v1.0.1
        # ("bafl", osp.join(root, "experiment_20241031_191513"), 4_000), # polaris for 1hr
        # ("bafl", osp.join(root, "experiment_20241031_160652"), 40_000),  # dijkstra
        # ("bafl", osp.join(root, "experiment_20241031_160652"), 6_000),  # dijkstra
        # v1.0.1 350ep
